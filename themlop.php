...
<body class="bg-gray-100">
          ...
          <div class="w-3/4">
            <div class="w-3/4 mx-auto bg-green-900 py-4 text-white text-center shadow-md rounded-t">
                <h1 class="text-2xl font-bold">Thêm Lớp Mới</h1>
            </div>
            ...
            <div class="w-3/4 mx-auto bg-green-50 p-6 shadow-md rounded-b">
                <form action="" method="POST">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block font-medium mb-1">Tên Lớp</label>
                            <input type="text" name="tenlop" required class="w-full px-3 py-2 border rounded focus:ring focus:border-green-500">
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Sĩ Số</label>
                            <input type="number" name="sosv" required min="1" class="w-full px-3 py-2 border rounded focus:ring focus:border-green-500">
                        </div>
                    </div>
                    <div class="pt-6">
